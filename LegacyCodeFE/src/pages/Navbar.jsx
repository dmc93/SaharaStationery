...
console.log("Before useEffect isAdmin is: " + isAdmin)
...
useEffect(() => {
    ...
    const handleMouseEnter = () => {
        console.log("Before MouseEnter useState set, isAdmin is: " + isAdmin)
        setIsOpen(true);
        console.log("After MouseEnter useState set, isAdmin is: " + isAdmin)
    };
